...
##### remove: UBERON:0005984 has_part UBERON:0001021: subendocardium layer has_part nerve
...
ontos$uberon$ont <- add_descendants(ontos$uberon$ont, descendant_relations = c("has_part","has_part(SUPP_INVERSE)"))
...
for(i in 1:length(onto$id)){
  ...
  onto$depth[i] <- get_depth_plus(onto$id[i],onto, ascendant_relations = c("has_part")) ## c("has_part","has_part(SUPP_INVERSE)")
}
