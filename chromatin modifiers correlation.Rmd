...
hist(kmt.kdm.vec[modifiers.p <= 0.05])
...
hist(kat.hdac.vec)
#histogram of correlation values with p<0.05
hist(kat.hdac.vec[modifiers.p <= 0.05])
...
hist(kmt.kat.vec)
#histogram of correlation values with p<0.05
hist(kmt.kat.vec[modifiers.p <= 0.05])
...
hist(kmt.hdac.vec)
#histogram of correlation values with p<0.05
hist(kmt.hdac.vec[modifiers.p <= 0.05])
...
hist(kdm.kat.vec)
#histogram of correlation values with p<0.05
hist(kdm.kat.vec[modifiers.p <= 0.05])
...
hist(kdm.hdac.vec)
#histogram of correlation values with p<0.05
hist(kdm.hdac.vec[modifiers.p <= 0.05])
...
hist(kmt.cor.vec)
#histogram of correlation values with p<0.05
hist(kmt.cor.vec[modifiers.p <= 0.05])
...
hist(kdm.cor.vec)
#histogram of correlation values with p<0.05
hist(kdm.cor.vec[modifiers.p <= 0.05])
...
hist(kat.cor.vec)
#histogram of correlation values with p<0.05
hist(kat.cor.vec[modifiers.p <= 0.05])
...
hist(hdac.cor.vec)
#histogram of correlation values with p<0.05
hist(hdac.cor.vec[modifiers.p <= 0.05])
...
#histogram of correlation values with p<0.05
h <- hist(modifiers.sig$r[modifiers.p <= 0.05])
h$density = h$counts/sum(h$counts)*100
plot(h,freq=FALSE, ylim=c(0,20))
histogram(modifiers.sig$r[modifiers.p <= 0.05])
