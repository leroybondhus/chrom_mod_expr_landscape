...
ggplot(kat6a_df, aes(x = pcw, y = log10(kat6a_expression+1), color = structures, group = structures)) + geom_line() + 
  theme(legend.position = "bottom") + ggtitle("KAT6A expression over time for each brain region")

kat6b_df <- data.frame(structures, pcw, kat6b_expression)
ggplot(kat6b_df, aes(x = pcw, y = log10(kat6b_expression+1), color = structures, group = structures)) + geom_line() + 
  theme(legend.position = "bottom")+ ggtitle("KAT6B expression over time for each brain region")
```
