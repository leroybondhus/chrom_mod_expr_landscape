...
for (dir in modest_cluster_names){
  if(!dir.exists(paste0(dirs$figure_cluster_analysis, resolution_dirs$chrom_modest,struct, "/", dir,"/"))){dir.create(paste0(dirs$figure_cluster_analysis,resolution_dirs$chrom_modest,struct,struct, "/", dir,"/"))}
