...
#(5) plot ALL unique epigenes: collapse nucleus sub-compartments 
  ...
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoli;Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nuclear bodies;Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cytosol;Nucleoplasm', 'Cytosol & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoli;Nucleoli rim', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Midbody;Nucleoplasm', 'Midbody & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cytosol;Vesicles', 'Cytosol & Vesicles'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoli fibrillar center;Nucleoli rim;Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cytosol;Mitochondria', 'Cytosol & Mitochondria'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nuclear speckles;Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cytosol;Nucleoli', 'Cytosol & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cytosol;Golgi apparatus', 'Cytosol & Golgi apparatus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Mitotic chromosome;Nucleoli rim', 'Mitotic chromosome & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoli;Nucleoli rim;Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Mitochondria;Nucleoplasm', 'Mitochondria & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoli fibrillar center', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoplasm;Vesicles', 'Nucleus & Vesicles'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Centriolar satellite;Nucleoplasm', 'Centriolar satellite & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Actin filaments;Cytosol', 'Actin filaments & Cytosol'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Mitotic chromosome;Nucleoli;Nucleoli rim', 'Mitotic chromosome & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoli rim;Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nuclear bodies;Nucleoli', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Golgi apparatus;Vesicles', 'Golgi apparatus & Vesicles'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cytosol;Nuclear bodies', 'Cytosol & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Microtubules;Nucleoli fibrillar center', 'Microtubules & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Endoplasmic reticulum;Nucleoplasm', 'Endoplasmic reticulum & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoli rim', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Golgi apparatus;Nucleoplasm', 'Golgi apparatus & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nuclear bodies', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cytosol;Plasma membrane', 'Cytosol & Plasma membrane'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoli fibrillar center;Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nuclear speckles', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nuclear membrane', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoplasm;Plasma membrane', 'Nucleus & Plasma membrane'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nucleoli', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nuclear bodies;Nucleoli;Nucleoli rim;Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Centrosome;Nucleoplasm', 'Centrosome & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Kinetochore;Nuclear bodies', 'Kinetochore & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cell Junctions;Nucleoplasm', 'Cell Junctions & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Mitotic chromosome;Nucleoli fibrillar center', 'Mitotic chromosome & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cytosol;Nucleoplasm;Plasma membrane', 'Cytosol, Nucleus, & Plasma membrane'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Nuclear membrane;Nucleoplasm', 'Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Cytosol;Nucleoli;Nucleoplasm', 'Cytosol & Nucleus'))
  # PLOTall_eg_nucleus<-PLOTall_eg_nucleus%>%mutate(across('Main.location', str_replace_all, 'Mitochondria;Nucleoli', 'Mitochondria & Nucleus'))
