...
#(13) remove all rows with 'NA' in df_gg$loc
...
###### (2) plot function1: density for each of the 3 location membership #########################

plot_density <- function(data, membership) {
  ...
  p <- ggplot() +
    ...
    theme_minimal() +
    ggtitle(paste("Membership:", membership))
...
plot_density(df_gg_p, "Endomembrane System")
  ggsave(  filename="240414_Epi-v-NonEpi_disorder-prop_Endomembrane.jpeg",
    plot = last_plot())


# Plot for "Cytoplasm" membership
plot_density(df_gg_p, "Cytoplasm")
  ggsave(  filename="240414_Epi-v-NonEpi_disorder-prop_Cytoplasm.jpeg",
    plot = last_plot())

# Plot for "Nucleus" membership
plot_density(df_gg_p, "Nucleus")
  ggsave(  filename="240414_Epi-v-NonEpi_disorder-prop_Nucleus.jpeg",
    plot = last_plot())




###### (4) plot function2 for all data in 1 #########################
...
plot_density2(df_gg_p)
  ggsave(filename="240414_Epi-v-NonEpi X Nuc-v-nonNuc_disorder-prop.jpeg",
    plot = last_plot())
