---
title: "SC_Gtex_workspace"
output: html_document
---

#### Start: Code lifted from gene_specificity project: specificity_paper_main.Rmd ####
...
```{r set up chromatin modifier table}
## read in chromatin_modifier_table 
