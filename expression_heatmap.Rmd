...
spec_genes <- intersect(gene_sets$human_chromatin_modifiers$gene_subsets$all_chrom_modifiers,rownames(temp_mat)) # A
#spec_genes <- intersect(gene_sets$human_chromatin_modifiers$gene_subsets$all_chrom_modifiers,names(global_taus)[global_taus > 0.4]) # B
...
result_df <- result_df[-c(85:92,93:96,112:117,130:135,146:165,183:232,244:245,253:254,256:257,277:340,350:434),]
# rownames(result_df) <- 1:nrow(result_df)
...
temp_list <- c(gene_sets$spec_onto,
               list(ubiq_chrom=gene_sets$ubiq_chrom,
                    ...
                    all=unique(gene_sets$genes_all$ensembl_gene_id) ))
