...
#legend
legend(x=0.4, y=-0.2, legend=paste(levels(as.factor(type.mod$Category))), col = coul, bty = "n", pch=20 , pt.cex = 2, cex=1, text.col="white", horiz = F)
```
