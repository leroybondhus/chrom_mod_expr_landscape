...
View(coldata)
## uberon does not encode musculature of body under musculoskeletal system which seems like an error
### CORRECTION - Uberon 
coldata[onto$ehh[[which(onto$name=="musculature of body")]],"musculoskeletal system"] <- T 
