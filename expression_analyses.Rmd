...
View(coldata)
## uberon does not encode skeletal musculature under musculoskeletal system which seems like an error
### CORRECTION - Uberon 
coldata[onto$ehh[[which(onto$name=="skeletal musculature")]],"musculoskeletal system"] <- T 
...
# temp_els <- temp_els | grepl("^anatomical entity$",onto$name)
# temp_els <- which(temp_els & temp_num_els > 1)
temp_els <- match("anatomical entity",onto$name)
