...
temp <- make.unique(temp_genes$ensembl_gene_id[match(rownames(dataset_list$E_MTAB_6967$mat), temp_genes$external_gene_name)])
...
rownames(dataset_list$GSE119945$mat) <- str_split_fixed(rownames(dataset_list$GSE119945$mat),"\\.",2)[,1]

rownames(dataset_list$ENCODE_MM_DEV$mat) <- str_split_fixed(rownames(dataset_list$ENCODE_MM_DEV$mat),"\\.",2)[,1]
