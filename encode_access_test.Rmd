...
temp <- tempfile()
download.file("https://ftp.ncbi.nlm.nih.gov/geo/series/GSE119nnn/GSE119945/suppl/GSE119945%5Fcell%5Fannotate%2Ecsv%2Egz", temp)
temp_data <- read.table(temp, skip = 0, header = TRUE, sep = ",")
file.remove(temp)
...
system(paste0("curl ",
              ...
              "> data/GSE119945_gene_count.txt.gz"))
temp_dat <- fread("data/GSE119945_gene_count.txt.gz" )

temp_data <- ReadMtx("data/GSE119945/gene_count.txt.gz",
                     cells = "data/GSE119945/cells.csv",
                     features = "data/GSE119945/genes.tsv",
                     #skip.cell = 1,
                     cell.sep = ",")
