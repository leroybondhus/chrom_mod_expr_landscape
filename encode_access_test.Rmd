...
temp_data <- ReadMtx( paste0(dirs$e_mtab_6967_atlas,"/raw_counts.mtx"),
                     cells = paste0(dirs$e_mtab_6967_atlas,"/meta.csv"),
                     features = paste0(dirs$e_mtab_6967_atlas,"/genes.tsv"),
                     skip.cell = 1,
                     cell.sep = ",")
...
dirs$GSE119945 <- paste0(data_dir,"GSE119945/")
