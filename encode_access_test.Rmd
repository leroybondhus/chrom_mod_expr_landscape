...
dirs$GSE78140 <- paste0(dirs$data_dir,"/GSE78140/")
if(!(dir.exists(dirs$GSE78140))){
  dir.create(dirs$GSE78140)
  system(paste0("curl ",
                "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE78nnn/",
                "GSE78140/matrix/GSE78140_series_matrix.txt.gz",
                paste0("> ",dirs$GSE78140,"/GSE78140_series_matrix.txt.gz" )))
  system(paste0("gunzip -c ",dirs$GSE78140,"/GSE78140_series_matrix.txt.gz > ",dirs$GSE119945,"/GSE78140_series_matrix.txt"))
