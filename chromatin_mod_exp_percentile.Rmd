...
Heatmap(kmt_ranknorm, name="Normalized Rank", cluster_rows=FALSE, cluster_columns= FALSE, column_names_gp = grid::gpar(fontsize = 9), row_names_gp = grid::gpar(fontsize = 9), width = unit(18, "cm"), height = unit(12, "cm"), col = colorRamp2(c(0.8, 0.5, 0, -0.5, -0.8), brewer.pal(n=5, name="RdBu")))
```
...
Heatmap(kat_ranknorm, name="Normalized Rank", cluster_rows=FALSE, cluster_columns= FALSE, column_names_gp = grid::gpar(fontsize = 9), row_names_gp = grid::gpar(fontsize = 9), width = unit(18, "cm"), height = unit(12, "cm"), col = colorRamp2(c(0.8, 0.5, 0, -0.5, -0.8), brewer.pal(n=5, name="RdBu")))
```
...
Heatmap(hdac_ranknorm, name="Normalized Rank", cluster_rows=FALSE, cluster_columns= FALSE, column_names_gp = grid::gpar(fontsize = 9), row_names_gp = grid::gpar(fontsize = 9), width = unit(18, "cm"), height = unit(12, "cm"), col = colorRamp2(c(0.8, 0.5, 0, -0.5, -0.8), brewer.pal(n=5, name="RdBu")))
```
