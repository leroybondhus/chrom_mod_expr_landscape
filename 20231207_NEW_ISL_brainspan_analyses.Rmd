...
# filtered_timepoints <- num_struct_timepoints[which(is.element(colnames(corr_matrix), structure_names))]
...
# partition epigenes corr based on neural specificity
...
epi_nervous_spec_corr_df <- melt(epi_nervous_spec_corr_summary_stats[,3:7]/nrow(epi_nervous_spec_corr), value.name = "count")

epi_non_nervous_spec_corr_df <- melt(epi_non_nervous_spec_corr_summary_stats[,3:7]/nrow(epi_non_nervous_spec_corr), value.name = "count")

nervous_spec_non_epi_spec_corr_df <- melt(nervous_spec_non_epi_corr_summary_stats[,3:7]/nrow(nervous_spec_non_epi_corr), value.name = "count")

not_nervous_spec_non_epi_corr_df <- melt(not_nervous_spec_non_epi_corr_summary_stats[,3:7]/nrow(not_nervous_spec_non_epi_corr), value.name = "count")
...
aggregate_corr_df = rbind(epi_nervous_spec_corr_df, epi_non_nervous_spec_corr_df, nervous_spec_non_epi_spec_corr_df, not_nervous_spec_non_epi_corr_df)

all_corr_gg <- ggplot(aggregate_corr_df, aes(x=variable, y=count, fill=gene_type, )) + 
  geom_boxplot() +
...
```{r, barplots for metacluster subcellular membership}
...
for (i in 1:length(cell_cycle_mcls)){
  ...
  main_mcls_subcell_df <- rbind(mcls_subcell_df, subcell_df)
}
