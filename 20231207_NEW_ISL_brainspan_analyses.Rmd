...
all_corr_gg_density <- ggplot(aggregate_corr_density_df, aes(x=value, fill=gene_type, )) + 
  geom_density() +
  facet_grid( is_chrom ~ is_spec) +
  scale_fill_manual(values=c('#C77CFF', '#00BFC4', '#F8766D', 'gold')) +
  theme_bw() +
...
ggplot(melt(epi_nervous_spec_corr), aes(x=value)) +
  geom_density() +
  ggtitle('neural specificity epigenes correlation density plot') +
  labs(x = "time correlation", y = "count") +
  theme_bw()
```
