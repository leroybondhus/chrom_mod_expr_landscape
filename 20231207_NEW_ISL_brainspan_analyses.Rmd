...
# download data from here: https://www.brainspan.org/api/v2/well_known_file_download/267666525
...
```{r, epigene expression threshold}
brainspan_chrom_mod <- rows_meta$ensembl_gene_id[matched_modifiers]
epigenes_norm_expr <- normal_expr[matched_modifiers,]

# find epigenes with at least 1 TPM in at least 1 tissue
tpm_threshold <- log10(1+1)
# Filter epigenes that have at least 1 TPM in at least 1 tissue
epigenes_with_tpm <- epigenes_norm_expr[rowSums(epigenes_norm_expr >= tpm_threshold) > 0, ]
nrow(epigenes_with_tpm) # 693 epigenes in at least 1 TPM in at least 1 tissue
```
